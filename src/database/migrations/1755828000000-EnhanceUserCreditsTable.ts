...
export class EnhanceUserCreditsTable1755828000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Remove new indexes
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_user_credits_user_id_active"`);

        // Remove new columns (in reverse order of creation)
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "metadata"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "playground_credits_next_reset"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "playground_credits_last_reset"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "api_credits_used_total"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "playground_credits_used_current_period"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "api_credits"`);
        await queryRunner.query(`ALTER TABLE "user_credits" DROP COLUMN IF EXISTS "playground_credits"`);
