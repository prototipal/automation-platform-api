...
export class UpdateTemplatesTableWithCategoryRelation1754513600000 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Add category_id column to templates table
        await queryRunner.addColumn('templates', new TableColumn({
            name: 'category_id',
            type: 'uuid',
        ...
        await queryRunner.changeColumn('templates', 'category_id', new TableColumn({
            name: 'category_id',
            type: 'uuid',
            isNullable: false,
        }));
